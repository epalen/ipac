...
<section class="invoice">
    ...
    <div class="row">
        <div class="col-xs-12">
            <p class="lead">Historía y detalle de la propuesta:</p>
        </div>
    </div>
    <ul class="timeline">
        ...
        <li>
            ...
            <div class="timeline-item">
                <span class="time"><i class="fa fa-clock-o"></i> {{ Carbon\Carbon::parse($comments->created_at)->format('h:i:s a') }}</span>

                <h3 class="timeline-header"><a href="#">{{ $comments->name }}</a></h3>
...
{!! Form::model($propuestas, ['method' => 'PATCH','route' => ['propuestas.close', $propuestas->id]]) !!}
        ...
        <div class="col-xs-12">
            @if(Auth::user()->hasRole(['manager', 'institutional_analyst', 'analyst_institutions']))
                <div class="form-group">
                    <strong>Agregar descripción para cierre de propuesta:</strong>
    ...
    <div class="row no-print">
        ...
        <button type="submit" class="btn btn-success pull-right" style="margin-right: 5px;">
            <i class="fa fa-lock"></i> Cerrar Propuesta
        </button>
        </div>
    </div>
{!! Form::close() !!}
