...
@include('administracion.permisos.incluir.herramientas')
	...
	<div class="col-xs-12">
		...
		<div class="box">
			...
			<div class="box-header">
				...
				{!! Form::open(['route' => 'permisos.inicio', 'method' => 'GET']) !!}
					    ...
					    @foreach ($data as $permisos)
							...
							<tr>
		                        ...
		                        <td align="center">
		                        	...
		                        	<a class="btn btn-default" href="{{ route('permisos.editar', $permisos->id) }}" data-toggle="tooltip" data-placement="top" title="Ver detalle de permiso">
		                        		<i class="fa fa-edit"></i> 
		                        	</a>
		                        	<a class="btn btn-default" href="{{ route('permiso.eliminar', $permisos->id) }}" data-toggle="tooltip" data-placement="top" title="Ver detalle de permiso">
