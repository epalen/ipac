	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-info">
	            ...
	            <!-- /.box-header -->
	            <!-- form start -->
	            {!! Form::open(array('route' => 'usuarios.guardar','method' => 'POST', 'enctype' => 'multipart/form-data')) !!}
		            <div class="col-xs-12">
	                    <div class="row">
							<div class="col-xs-4">
								<div class="form-group">
									<strong>Nombres:</strong>
									{!! Form::text('name', old('name'), array('placeholder' => 'Ingresar nombres','class' => 'form-control')) !!}
									@if ($errors->has('name'))
                	...
                	@endif
							...
							<div class="col-xs-4">
								<div class="form-group">
									...
									{!! Form::text('lastname', old('lastname'), array('placeholder' => 'Ingresar apellidos','class' => 'form-control')) !!}
                	...
                	@endif
							...
							<div class="col-xs-4">
								<div class="form-group">
									<strong>Email:</strong>
									{!! Form::text('email', old('email'), array('placeholder' => 'Ingresar correo institucional','class' => 'form-control')) !!}
									@if ($errors->has('email'))
                	...
                	@endif
							...
							<div class="col-xs-4">
								<div class="form-group">
									<strong>Area:</strong>
									{!! Form::text('area', old('area'), array('placeholder' => 'Ingresar Area laboral','class' => 'form-control')) !!}
									@if ($errors->has('area'))
                	...
                	@endif
	                    	...
	                    	<div class="col-xs-4">
								<div class="form-group">
									...
									{!! Form::text('job_title', old('job_title'), array('placeholder' => 'Ingresar posición de area laboral','class' => 'form-control')) !!}
                	...
                	@endif
                  	...
                  	{!! $errors->first('gender', '<label class="control-label" style="color:red">:message</label>') !!}
                	@endif -->
								</div>
							</div>							 
							<div class="col-xs-3">
								<div class="form-group">
									...
									{!! Form::text('phone', old('phone'), array('placeholder' => 'Ingresar número de telefono','class' => 'form-control')) !!}
									@if ($errors->has('phone'))
                	...
                	@endif
							...
							<div class="col-xs-3">
								<div class="form-group">
									...
									{!! Form::text('extension', old('extension'), array('placeholder' => 'Ingresar número','class' => 'form-control')) !!}
                	...
                	@endif
							...
							<div class="col-xs-3">
								<div class="form-group">
									<strong>Flota:</strong>
									{!! Form::text('movil', old('movil'), array('placeholder' => 'Ingresar número de flota','class' => 'form-control')) !!}
									@if ($errors->has('movil'))
                	...
                	@endif
	                    	...
	                    	<div class="col-xs-4 pull-right">	
								...
								<div class="form-group">					
								  {!! Form::select('roles[]', $roles,[], array('class' => 'form-control', 'size' => '5x5', 'multiple')) !!}
									@if ($errors->has('roles'))
